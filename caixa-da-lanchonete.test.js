...
describe('CaixaDaLanchonete', () => {
    ...
    describe('Mais Testes', () => {
        ...
        test.each([
            ['compra de combo1 com extra', 'credito', 'R$ 11,03', ['combo1,1', 'chantily,1']],
            ['compra de combo2 com extra', 'debito', 'R$ 10,08', ['combo2,1', 'queijo,1']],
        ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
            validaTeste(formaDePagamento, resultadoEsperado, itens));

        test.each([
            ['compra de combo com extras iguais', 'credito', 'R$ 12,60', ['combo1,1', 'chantily,2']],
            ['compra de combo com extras diferentes', 'debito', 'R$ 11,55', ['combo2,1', 'queijo,1', 'chantily,1']],
        ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
            validaTeste(formaDePagamento, resultadoEsperado, itens));
    });
});
